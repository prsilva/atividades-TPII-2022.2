...
export default class ListagemDepTit extends Processo {
    ...
    processar(): void {
        ...
        var processo = false
        let dependente = this.entrada.receberTexto('| Digite o número do documento do cliente dependente: ')

        console.log('-----Lista do cliente titular-----')
